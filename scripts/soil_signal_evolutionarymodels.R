...
temperature <- read.csv("./environment_final_species_averages/environment_final_species_averages/kew_names_carolcorrected/BIOCLIM_1.average.final.csv", header = FALSE, stringsAsFactors = FALSE, row.names = NULL, sep = "\t")
colnames(temperature) <- c("species", "temperature")
temperature <- distinct(temperature, species, .keep_all= TRUE)

bio3 <- read.table("./environment_final_species_averages/environment_final_species_averages/kew_names_carolcorrected/BIOCLIM_3.average.final.csv", header = FALSE, stringsAsFactors = FALSE, row.names = NULL, sep = "\t")
colnames(bio3) <- c("species", "bio3")
bio3 <- distinct(bio3, species, .keep_all= TRUE)

bio4 <- read.table("./environment_final_species_averages/environment_final_species_averages/kew_names_carolcorrected/BIOCLIM_4.average.final.csv", header = FALSE, stringsAsFactors = FALSE, row.names = NULL, sep = "\t")
colnames(bio4) <- c("species", "bio4")
bio4 <- distinct(bio4, species, .keep_all= TRUE)

precipitation <- read.table("./environment_final_species_averages/environment_final_species_averages/kew_names_carolcorrected/BIOCLIM_12.average.final.csv", header = FALSE, stringsAsFactors = FALSE, row.names = NULL, sep = "\t")
colnames(precipitation) <- c("species", "precipitation")
precipitation <- distinct(precipitation, species, .keep_all= TRUE)

bio15 <- read.table("./environment_final_species_averages/environment_final_species_averages/kew_names_carolcorrected/BIOCLIM_15.average.final.csv", header = FALSE, stringsAsFactors = FALSE, row.names = NULL, sep = "\t")
colnames(bio15) <- c("species", "bio15")
bio15 <- distinct(bio15, species, .keep_all= TRUE)

bio17 <- read.table("./environment_final_species_averages/environment_final_species_averages/kew_names_carolcorrected/BIOCLIM_17.average.final.csv", header = FALSE, stringsAsFactors = FALSE, row.names = NULL, sep = "\t")
